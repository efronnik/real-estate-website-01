...
- `STRAPI_API_TOKEN` (server-only token with permission to create leads)
...
- Lead creation goes through the Next.js `/api/leads` proxy, authenticated to Strapi with `STRAPI_API_TOKEN`
