...
describe("buildLeadPayloadFromFormData", () => {
  ...
  it("preserves valuation property details in the message payload", () => {
    const payload = buildLeadPayloadFromFormData(
      formDataFrom({
    ...
    expect(payload.message).toContain("Dodatkowe informacje:\nProsze o kontakt rano.");
  });
});
