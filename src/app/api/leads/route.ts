...
function getAllowedOrigins(): Set<string> {
  const configuredOrigin = normalizeOrigin(process.env.NEXT_PUBLIC_SITE_URL ?? DEFAULT_SITE_URL);
  return new Set([...LOCAL_ALLOWED_ORIGINS, ...(configuredOrigin ? [configuredOrigin] : [])]);
}
