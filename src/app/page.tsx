    ...
    <>
      <main>
        <section className="cp-hero">
          ...
          <div className="cp-content">
            ...
            <div className={`hero-cta-row ${heroReady ? "ready" : ""}`}>
              <a href={ROUTE_PATHS.sprzedaz} className="cp-btn hero-cta hero-cta-primary">
                <span className="prefooter-btn-text-wrap" aria-hidden="true">
                  <span className="prefooter-btn-text prefooter-btn-text-top">Sprzedaj</span>
                  <span className="prefooter-btn-text prefooter-btn-text-bottom">Sprzedaj</span>
                </span>
                <span className="sr-only">Sprzedaj</span>
                <span className="prefooter-btn-arrow" aria-hidden="true">→</span>
              </a>
              <a href={ROUTE_PATHS.inwestycje} className="cp-btn hero-cta hero-cta-secondary">
                <span className="prefooter-btn-text-wrap" aria-hidden="true">
                  <span className="prefooter-btn-text prefooter-btn-text-top">Inwestuj</span>
                  <span className="prefooter-btn-text prefooter-btn-text-bottom">Inwestuj</span>
                </span>
                <span className="sr-only">Inwestuj</span>
                <span className="prefooter-btn-arrow" aria-hidden="true">→</span>
              </a>
            </div>
          </div>
        ...
        <LeadContactSection
          ...
          description="Pracujemy lokalnie, ale prowadzimy proces end-to-end. Dostajesz strategie, egzekucje i bezpieczny final sprzedazy."
        />
      </main>
