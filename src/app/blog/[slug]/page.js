...
export default function BlogArticlePage() {
    ...
    const signalCardRefs = useRef([]);
    const mistakeCardRefs = useRef([]);
    const frameworkSteps = useMemo(() => {
        var _a;
        const list = (_a = article === null || article === void 0 ? void 0 : article.framework) !== null && _a !== void 0 ? _a : [];
        return list.map((step, idx) => {
            var _a;
            const [left, ...right] = step.split(":");
            return {
                label: String(idx + 1).padStart(2, "0"),
                title: (left === null || left === void 0 ? void 0 : left.trim()) || `Krok ${idx + 1}`,
                text: right.join(":").trim() || step,
                hero: (_a = frameworkHeroWords[idx]) !== null && _a !== void 0 ? _a : "Etap",
    ...
    const mistakeCards = useMemo(() => {
        var _a;
        return ((_a = article === null || article === void 0 ? void 0 : article.mistakes) !== null && _a !== void 0 ? _a : []).map((text, idx) => ({
            text,
    ...
    const checklistCards = useMemo(() => {
        var _a;
        return ((_a = article === null || article === void 0 ? void 0 : article.checklist) !== null && _a !== void 0 ? _a : []).map((text, idx) => {
            var _a, _b;
            return ({
                title: text,
                text: (_a = article === null || article === void 0 ? void 0 : article.checklistCardText) !== null && _a !== void 0 ? _a : "Element checklisty do wdrożenia przed kolejnym etapem sprzedaży.",
                metric: (_b = article === null || article === void 0 ? void 0 : article.checklistMetric) !== null && _b !== void 0 ? _b : "Checklista wdrożenia",
                image: checklistImages[idx % checklistImages.length],
            });
        });
    }, [article]);
    const showFrameworkSection = ((_a = article === null || article === void 0 ? void 0 : article.showFramework) !== null && _a !== void 0 ? _a : true) && frameworkSteps.length > 0;
    const showMistakesSection = ((_b = article === null || article === void 0 ? void 0 : article.showMistakes) !== null && _b !== void 0 ? _b : true) && mistakeCards.length > 0;
    useEffect(() => {
        if (!article)
            return;
    ...
    if (!article) {
        return (_jsx("main", { className: "article-page", children: _jsx("section", { className: "section", children: _jsxs("div", { className: "container article-shell", children: [_jsx("p", { className: "eyebrow", children: "Blog" }), _jsx("h1", { className: "section-title", children: "Artyku\u0142 nie zosta\u0142 znaleziony" }), _jsx("p", { className: "section-copy", children: "Sprawd\u017A list\u0119 materia\u0142\u00F3w na stronie bloga." }), _jsx("a", { href: ROUTE_PATHS.blog, className: "link-arrow", children: "Wr\u00F3\u0107 do bloga" })] }) }) }));
    }
    const checklistRelativeIndex = (idx) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("main", { className: `article-page ${hasHero ? "article-page--hero" : ""}`, children: [_jsx(SiteTopbar, {}), hasHero && (_jsxs("section", { className: "section article-hero", children: [_jsx("video", { className: "article-hero-video", autoPlay: true, muted: true, loop: true, playsInline: true, preload: "metadata", "aria-hidden": "true", children: _jsx("source", { src: "/Hero-7.mp4", type: "video/mp4" }) }), _jsx("div", { className: "article-hero-overlay", "aria-hidden": "true" }), _jsxs("div", { className: "container article-hero-shell", children: [_jsx("p", { className: "eyebrow", children: article.category }), _jsx("h1", { className: "section-title", children: article.title }), _jsx("p", { className: "section-copy", children: article.lead }), _jsx("p", { className: "article-meta", children: article.readTime })] })] })), _jsxs("section", { className: "section", children: [_jsxs("div", { className: "container article-shell", children: [!hasHero && (_jsxs(_Fragment, { children: [_jsx("p", { className: "eyebrow", children: article.category }), _jsx("h1", { className: "section-title", children: article.title }), _jsx("p", { className: "section-copy", children: article.lead }), _jsx("p", { className: "article-meta", children: article.readTime })] })), !!((_c = article.signals) === null || _c === void 0 ? void 0 : _c.length) && (_jsxs("div", { className: "signals-layout", children: [_jsxs("aside", { className: "signals-copy", children: [_jsxs("div", { className: "signals-progress", children: [activeSignalIndex + 1, " / ", article.signals.length] }), _jsx("p", { className: "signals-lead", children: (_d = article.signals[activeSignalIndex]) === null || _d === void 0 ? void 0 : _d.title })] }), _jsx("div", { className: "signals-visuals", children: article.signals.map((signal, idx) => (_jsxs("article", { ref: (el) => { signalCardRefs.current[idx] = el; }, className: `signal-card ${idx === activeSignalIndex ? "active" : ""}`, style: { ["--bg"]: `url(${signal.image})` }, children: [_jsxs("p", { children: [_jsx("strong", { children: "Dlaczego to wa\u017Cne:" }), " ", signal.why] }), _jsxs("p", { children: [_jsx("strong", { children: "Co zrobi\u0107:" }), " ", signal.action] })] }, signal.title))) })] }))] }), showFrameworkSection && (_jsxs("div", { className: "article-process-wrap process", children: [_jsx("div", { className: "container", children: _jsxs("header", { className: "process-head", children: [_jsx("p", { className: "eyebrow", children: (_e = article.frameworkEyebrow) !== null && _e !== void 0 ? _e : "Plan pracy" }), _jsx("h2", { className: "section-title", children: (_f = article.frameworkTitle) !== null && _f !== void 0 ? _f : "Plan działania na 14 dni" })] }) }), _jsx("div", { className: "service-board", children: frameworkSteps.map((step) => (_jsxs("article", { className: "service-row", style: { ["--bg"]: `url(${step.image})` }, children: [_jsxs("div", { className: "service-info", children: [_jsx("p", { className: "idx", children: _jsx("span", { className: "idx-text", children: step.label }) }), _jsx("h3", { children: step.title }), _jsx("p", { children: step.text })] }), _jsx("div", { className: "service-word", children: _jsx("span", { children: step.hero }) })] }, step.label))) })] })), _jsxs("div", { className: "container article-shell", children: [showMistakesSection && (_jsxs("div", { className: "article-mistakes-layout", children: [_jsxs("aside", { className: "article-mistakes-copy", children: [_jsx("h2", { children: (_g = article.mistakesTitle) !== null && _g !== void 0 ? _g : "Najczęstsze błędy przy korekcie ceny" }), _jsx("p", { children: "To punkty, kt\u00F3re najcz\u0119\u015Bciej psuj\u0105 pozycj\u0119 negocjacyjn\u0105 i wyd\u0142u\u017Caj\u0105 sprzeda\u017C. Je\u015Bli wyeliminujesz je na starcie, decyzje cenowe b\u0119d\u0105 bardziej przewidywalne i oparte na danych." })] }), _jsx("div", { className: "article-mistakes-visuals", children: _jsx("div", { className: "article-mistakes-grid", children: mistakeCards.map((item, idx) => (_jsxs("article", { ref: (el) => { mistakeCardRefs.current[idx] = el; }, className: `article-mistake-item ${idx === activeMistakeIndex ? "active" : ""}`, children: [_jsx("img", { src: item.image, alt: item.text }), _jsx("p", { children: item.text })] }, item.text))) }) })] })), !!checklistCards.length && (_jsxs("div", { className: "article-checklist-stage", children: [_jsx("div", { className: "article-checklist-head", children: _jsx("h2", { className: "section-title", children: (_h = article.checklistTitle) !== null && _h !== void 0 ? _h : "Checklista do wdrożenia" }) }), _jsx("div", { className: "article-checklist-carousel", onMouseEnter: () => setIsChecklistPaused(true), onMouseLeave: () => setIsChecklistPaused(false), children: checklistCards.map((item, idx) => {
                                                    const r = checklistRelativeIndex(idx);
                                                    return (_jsx("article", { className: `article-checklist-panel ${r === 0 ? "center" : ""} ${r === -1 ? "left" : ""} ${r === 1 ? "right" : ""} ${Math.abs(r) > 1 ? "hidden" : ""}`, style: { ["--bg"]: `url(${item.image})` }, onClick: () => setCurrentChecklistSlide(idx), children: _jsxs("div", { className: "article-checklist-panel-overlay", children: [_jsx("p", { className: "article-checklist-kicker", children: String(idx + 1).padStart(2, "0") }), _jsx("h3", { children: item.title }), _jsx("p", { children: item.text }), _jsx("div", { className: "article-checklist-metric", children: item.metric })] }) }, item.title));
                                                }) }), _jsx("div", { className: "article-checklist-dots", role: "tablist", "aria-label": "Nawigacja checklisty", children: checklistCards.map((item, idx) => (_jsx("button", { className: `article-checklist-dot ${idx === currentChecklistSlide ? "active" : ""}`, "aria-label": `Przejdź do elementu checklisty ${idx + 1}`, onClick: () => setCurrentChecklistSlide(idx), children: _jsx("span", { className: "dot-core" }) }, `checklist-dot-${item.title}`))) })] })), !!article.closing && _jsx("p", { className: "article-closing", children: article.closing })] })] })] }), _jsxs("div", { className: "footer-stack", children: [_jsx(Prefooter, { kicker: "Koniec przewijania? Zr\u00F3bmy pierwszy krok.", title: "Sprzedaj mieszkanie spokojnie i na dobrych warunkach.", buttons: [{ href: "/kontakt", label: "Umów konsultację" }] }), _jsx(SiteFooter, { year: year })] }), _jsx(ScrollToTopButton, {})] }));
}
